...
class UserPreferences(Base):
    ...
    topics = Column(JSON, default=list)  # ["tech", "business", "science", "ai", "startups", etc.]
    ...
    reading_history_weight = Column(Integer, default=5)  # 1-10, how much to weight past reading
