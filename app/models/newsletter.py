from sqlalchemy import Column, String, DateTime, JSON, Text, ForeignKey, Enum, Integer, Float
...
class Newsletter(Base):
    ...
    content_sections = Column(JSON, default=list)  # [{"type": "section", "title": "...", "content": "..."}]
    ...
    sources_used = Column(JSON, default=list)  # [{"url": "...", "title": "...", "summary": "..."}]
    ...
    history_entries = relationship("NewsletterHistory", back_populates="newsletter", cascade="all, delete-orphan")