from sqlalchemy import Column, String, DateTime, JSON, Text, ForeignKey, Enum, Boolean, Integer, Float
...
class NewsletterHistory(Base):
    ...
    location_data = Column(JSON, default=dict)  # {"country": "US", "city": "San Francisco"}
