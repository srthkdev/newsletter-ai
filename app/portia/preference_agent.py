...
class NewsletterPreferenceAgent(BaseNewsletterAgent):
    ...
    async def _update_preferences(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Store in memory
            success = await self.memory.store_user_preferences(user_id, preferences_with_metadata)
            
            if success:
                # Generate personalization profile
                profile = await self._generate_personalization_profile(preferences_with_metadata)
    ...
    async def _analyze_preferences(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if not user_id:
                return {
                    "success": False,
                    "error": "User ID is required for analysis"
                }
            ...
            # Analyze the data
            analysis = self._analyze_user_data(preferences, engagement, reading_patterns)
    ...
    async def _recommend_preferences(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            recommendations = self._generate_preference_recommendations(analysis, current_preferences)
    ...
    async def _execute_full_preference_management(self, context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _generate_personalization_profile(self, preferences: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _analyze_user_data(
        ...
        if preferences:
            ...
            if len(topics) > 5:
                analysis["insights"].append("User has diverse interests with many topics selected")
            elif len(topics) < 2:
                analysis["optimization_opportunities"].append("Consider adding more topics for better content variety")
        ...
        if engagement:
            ...
            open_rate = (total_opens / total_newsletters) * 100 if total_newsletters > 0 else 0
            ...
            if open_rate < 30:
                analysis["optimization_opportunities"].append("Low open rate - consider improving subject lines or send timing")
            if click_rate < 10:
                analysis["optimization_opportunities"].append("Low click rate - content might need to be more engaging")
        ...
        if reading_patterns:
            ...
            if "preferred_topics" in reading_patterns:
                analysis["insights"].append(f"Most engaged with: {reading_patterns['preferred_topics'][:3]}")
        
        return analysis
    
    def _summarize_engagement(self, engagement: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            ...
            "open_rate": round((total_opens / total_newsletters) * 100, 1) if total_newsletters > 0 else 0,
            "click_rate": round((total_clicks / total_opens) * 100, 1) if total_opens > 0 else 0,
            "engagement_level": self._calculate_engagement_level(total_opens, total_clicks, total_newsletters)
        }
    
    def _summarize_reading_patterns(self, reading_patterns: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _calculate_engagement_level(self, opens: int, clicks: int, newsletters: int) -> str:
        ...
        for opportunity in opportunities:
            if "topics" in opportunity.lower():
                recommendations.append({
                    ...
                    "action": "add_topics",
                    "priority": "medium",
                    "suggested_topics": ["artificial intelligence", "innovation", "productivity"]
                })
                ...
                recommendations.append({
                    ...
                    "priority": "high",
                    "suggested_changes": ["Try different send times", "Consider frequency adjustment"]
                })
                ...
                recommendations.append({
                    ...
                    "action": "adjust_tone",
                    "priority": "medium",
                    "suggested_changes": ["Try a more casual tone", "Include more actionable insights"]
                })
